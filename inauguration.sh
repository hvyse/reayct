...
UUID=${UUID:-'fc4438be-8639-429f-a283-a900ac2befae'}
VMESS_WSPATH=${VMESS_WSPATH:-'/sbRcC'}
VLESS_WSPATH=${VLESS_WSPATH:-'/y9OLWwA'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/T3Bte'}
SS_WSPATH=${SS_WSPATH:-'/T8gwUJhQyFrWCp'}
